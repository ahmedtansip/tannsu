...
jQuery(function($){
	...
	*/
	...
	$(document).ready(function(){
		...
		// delay load the banner image for blog
		setTimeout(function () {
			$('body.single-post .load-delay-custom').each(function () {
				var grav_banner_img = $(this);
				var imgOriginal = grav_banner_img.data('original');
				
				$(grav_banner_img).css('background-image', 'url(' + imgOriginal + ')');
			});
		}, 2500);
